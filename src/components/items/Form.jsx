    ...
    return (
...

        {
          ...
          <div className="search absolute mt-1 right-7 sm:right-1/14 md:right-1/25 lg:right-1/30 max-h-[100vh] rounded-sm overflow-scroll z-10">
            {shows.map((index) => (
                <Link to={`/movie/${index.show.id}`} key={index.show.id} onClick={() => setQuery('')} className="flex gap-3 p-1 h-30 sm:h-35 lg:h-38 xl:h-40 w-[205px] sm:w-[230px] md:w-[250px] xl:w-[280px] bg-gray-50 border border-transparent border-b-gray-300">
