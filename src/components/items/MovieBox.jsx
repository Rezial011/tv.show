...
export default function MovieBox() {
    ...
    return (
        ...
        {
        shows.map((index) => (
            <Link to={`/movie/${index.id}`} key={index.id} href="#" className="movieBox relative w-[110px] h-[240px] sm:w-[130px] sm:h-[270px] md:w-[185px] md:h-[335px] lg:w-[190px] lg:h-[350px] xl:w-[200px] xl:h-[360px] rounded-sm my-1 text-wrap overflow-hidden shadow-lg">
