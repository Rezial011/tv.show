...
export default function SeasonBox({cover, name}) {
    ...
    return (
        <div className="season flex flex-wrap gap-x-1 gap-y-3  justify-evenly">
        {
        seasons.map((season) => (
            <div key={season.id} href="#" className="movieBox relative pb-3 w-[110px] h-auto sm:w-[130px] md:w-[185px] lg:w-[190px] xl:w-[200px] rounded-sm my-1 text-wrap overflow-hidden shadow-lg">
                ...
                <h1 className="mx-2 md:mx-3 font-medium genre text-[14px] sm:text-[16px] line-clamp-2 leading-4 mt-2 mb-1">{season?.name || `Season ${season.number}`}</h1>
